...
const BIRTHDAYS = [
  {
    year: 2026,
    xiang: { name: "严浩翔", date: "08-16", wish: "（2026 年 8 月 16 日尚未到来，敬请期待 ✦）", link: "", reply: "", pics: [], letter: "" },
    jun:   {
      name: "贺峻霖", date: "06-15",
  ...
  },
  {
    ...
    jun:   {
      name: "贺峻霖", date: "06-15",
      wish: "@时代少年团-贺峻霖 生日快乐贺！夏天又到了，祝出生在夏天的你永远像夏天一样开心又耀眼。用坚定又柔韧的心，继续去做自己喜欢的事情，一起加油吧🔥",
  ...
  {
    // 特别珍藏：TF 家族时期的影像记录（只有严浩翔生日一张卡，jun 置 null 不渲染）
    year: 2016,
    xiang: {
      name: "严浩翔", date: "08-16",
      wish: "严浩翔 12 岁生日 · TF 家族时期的珍贵影像",
      link: "",
      reply: "",
      pics: [],
      letter: "",
